  ...
  for (const size of SIZES) {
    for (const colour of COLOURS) {
      ...
      const items = [
        ...
        { sku: "FK-Ex", qty: 2, componentRole: "hardware_bracket", altGroupKey: null, nonConstraining: false },
        { sku: "CXH", qty: 1, componentRole: "hardware_bracket", altGroupKey: null, nonConstraining: true },
