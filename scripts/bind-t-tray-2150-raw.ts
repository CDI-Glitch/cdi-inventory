/**
 * Set sellableSku on Extra Cab 2150 RAW, bind Shopify IDs, refresh kits, push.
 * Run: npx tsx scripts/bind-t-tray-2150-raw.ts
 */
...
const TARGETS = [{ code: "BDL-TT-2150-RAW", sellableSku: "BDL-TT-2150-RAW" }];
