/**
 * Set sellableSku on Extra Cab 2150 SHB/W, bind Shopify IDs, refresh kits, push.
 * Run: npx tsx scripts/bind-t-tray-2150-shb-w.ts
 */
...
const TARGETS = [
  { code: "BDL-TT-2150-SHB", sellableSku: "BDL-TT-2150-SHB" },
  { code: "BDL-TT-2150-W", sellableSku: "BDL-TT-2150-W" },
];
