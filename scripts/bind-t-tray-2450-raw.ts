/**
 * Set sellableSku on Single Cab 2450 RAW, bind Shopify IDs, refresh kits, push.
 * Run: npx tsx scripts/bind-t-tray-2450-raw.ts
 */
...
const TARGETS = [{ code: "BDL-TT-2450-RAW", sellableSku: "BDL-TT-2450-RAW" }];
